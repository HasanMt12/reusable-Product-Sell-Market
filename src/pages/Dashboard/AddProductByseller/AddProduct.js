					...
					<div className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm  bg-slate-600">
						<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
							...
							<div className="col-span-full sm:col-span-2">
								...
								{ required: "name is required"}
									)} type="text" required defaultValue={user?.email} className="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400  border-gray-700  text-gray-900" />
