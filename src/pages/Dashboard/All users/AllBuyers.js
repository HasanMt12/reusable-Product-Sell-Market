             ...
             <div className="overflow-x-auto mt-6 mx-10/12">
                <table className="table w-11/12  mx-auto">
                    ...
                    >
                            ...
                            <td>{b.role}  </td>
                            <td>
                  <label onClick={() => setDeletingUser(b)} htmlFor="confirmation-modal" className="btn btn-sm btn-error"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
